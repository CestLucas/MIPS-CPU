...
HD_PWD='C:/Users/Lucas/Documents/Final Project/Final Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log miniCPU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source miniCPU.tcl -notrace
