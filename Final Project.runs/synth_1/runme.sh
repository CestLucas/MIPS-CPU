...
HD_PWD='C:/Users/Lucas/Documents/Final Project/Final Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log miniCPU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source miniCPU.tcl
